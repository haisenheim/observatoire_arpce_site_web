...
class CompteController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('/Marchand/Compte/index')->with(compact('users','sites'));
    }
    ...
    public function getSites(){
        $sites = Site::where('fournisseur_id',auth()->user()->fournisseur_id)->get();
        $villes = Ville::all();
        return view('/Marchand/Parametres/sites')->with(compact('sites','villes'));
    }

    public function getSite($token){
        $site = Site::where('token',$token)->first();
        return view('/Marchand/Compte/sites')->with(compact('site'));
    }
