...
class PromotionController extends ExtendedController
{
    ...
    public function index()
    {
        ...
        return view('/Site/Promotions/index')->with(compact('promotions'));
    }
    ...
    {
        //
        return view('/Site/Promotions/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/Site/promotions/'.$promotion->token);
    }
	...
	public function show($token)
	{
		...
		return view('/Site/Promotions/show')->with(compact('promotion'));
	}
    ...
    public function booster($token)
	{
		...
		return view('/Site/Promotions/booster')->with(compact('promotion','objectifs'));
	}
