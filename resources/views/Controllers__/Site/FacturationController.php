...
class FacturationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('/Site/Facturation/index')->with(compact('factures'));
    }
    ...
    public function getBonAchat($token){
        ...
        return view('Site.Facturation.bon')->with(compact('bon','fournisseur'));
    }
    ...
    public function getFacture($token){
        ...
        return view('/Site/Facturation/facture')->with(compact('facture'));
    }
    ...
    public function previewBon(){
        ...
        return view('Site/Facturation/preview_bons')->with(compact('data','dt'));
    }
    ...
    public function getAllBonAchat(){
        ...
        return view('Site/Facturation/all_bons')->with(compact('bons',));
    }
