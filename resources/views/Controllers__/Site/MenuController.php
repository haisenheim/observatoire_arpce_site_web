...
class MenuController extends ExtendedController
{
    ...
    public function index()
    {
        ...
        return view('/Site/Menus/index')->with(compact('menus'));
    }
    ...
    public function save(Request $request)
    {
       ...
       // $data['token'] = sha1(time().auth()->user()->fournisseur_id);
        ...
        return redirect('/Site/menus/'.$promotion->token);
    }
	...
	public function show($token)
	{
		...
		return view('/Site/Menus/show')->with(compact('promotion'));
	}
