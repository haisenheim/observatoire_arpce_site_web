    ...
    <!-- Brand Logo -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/admin/fournisseurs" class="nav-link {{ $active==21?'active':'' }}">
          ...
          <li class="nav-item">
            <a href="/admin/ventes" class="nav-link {{ $active==2?'active':'' }}">
          ...
          <li class="nav-item">
            <a href="/admin/articles" class="nav-link {{ $active==4?'active':'' }}">
          ...
          <li class="nav-item">
            <a href="/admin/fidelite" class="nav-link {{ $active==5?'active':'' }}">
          ...
          <li class="nav-item">
            <a href="/admin/litiges" class="nav-link {{ $active==6?'active':'' }}">
          ...
          <li class="nav-item">
            <a href="/admin/rapports" class="nav-link {{ $active==7?'active':'' }}">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/admin/tfournisseurs" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Familles de fournisseurs</p>
                </a>
              </li>
              <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="/admin/compte" class="nav-link {{ $active==8?'active':'' }}">
              <i class="nav-icon fas fa-cogs"></i>
              <p>
