      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item {{ $active==10?'active':'' }}">
            <a href="#" class="nav-link">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="/marchand/bons/valides" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>BONS VALIDES</p>
                  </a>
                </li>
                <li class="nav-item">
                    <a href="/marchand/bons/preview" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>PREVISUALISATION</p>
                    </a>
                  </li>
                <li class="nav-item">
                    <a href="/marchand/bons/consommes" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>BONS CONSOMMES</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/marchand/bons/expires" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>BONS EXPIRES</p>
                    </a>
                </li>
          ...
          <li class="nav-item {{ $active==11?'active':'' }}">
            <a href="/marchand/factures" class="nav-link">
          ...
          <li class="nav-item {{ $active==8?'active':'' }}">
            <a href="#" class="nav-link">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="/marchand/stats/global" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>ETAT GLOBAL</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="/marchand/stats/pareto" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>PARETO</p>
                    </a>
                </li>
          ...
          <li class="nav-item {{ $active==2?'active':'' }}">
            <a href="#" class="nav-link">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="/marchand/parametres/compte" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>AGENTS</p>
                  </a>
                </li>
                <li class="nav-item">
                    <a href="/marchand/telechargements" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>COMPTES CLIENTS</p>
                    </a>
                  </li>
                <li class="nav-item">
                    <a href="/marchand/parametres/categories" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>RAYONS</p>
                    </a>
                  </li>
                <li class="nav-item">
                    <a href="/marchand/parametres/sites" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>SITES</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/marchand/parametres/magasin" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>MAGASIN</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/marchand/parametres/questions" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>FAQs</p>
                    </a>
                </li>
