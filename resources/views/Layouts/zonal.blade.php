 ...
 <!-- <div style="background: linear-gradient(to right, #5bbdd6,#FFFFFF,#5bbdd6);" class="preloader flex-column justify-content-center align-items-center">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link"  href="#"><i class="fas fa-user"></i> {{ $cmpt->name }} / <b class="text-black">{{ $cmpt->zone->name }}</b> </a>
      </li>
    ...
    <!-- Brand Logo -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/zone/dashboard" class="nav-link {{ $active==1?'active':'' }}">
          ...
          <li class="nav-item">
            <a href="/zone/producteurs" class="nav-link {{ $active==21?'active':'' }}">
          ...
          <li class="nav-item">
            <a href="/zone/cooperatives" class="nav-link {{ $active==2?'active':'' }}">
          ...
          <li class="nav-item">
            <a href="/zone/gics" class="nav-link {{ $active==3?'active':'' }}">
              <i class="nav-icon fas fa-home"></i>
              <p>
                Gics
              </p>
          ...
          <li class="nav-item">
            <a href="/zone/villages" class="nav-link {{ $active==3?'active':'' }}">
