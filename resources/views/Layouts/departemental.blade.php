 ...
 <!-- <div style="background: linear-gradient(to right, #5bbdd6,#FFFFFF,#5bbdd6);" class="preloader flex-column justify-content-center align-items-center">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link"  href="#"><i class="fas fa-user"></i> {{ $cmpt->name }} / <b class="text-black">{{ $cmpt->departement->name }}</b> </a>
      </li>
    ...
    <!-- Brand Logo -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/departemental/dashboard" class="nav-link {{ $active==1?'active':'' }}">
          ...
          <li class="nav-item">
            <a href="/departemental/producteurs" class="nav-link {{ $active==21?'active':'' }}">
          ...
          <li class="nav-item">
            <a href="/departemental/cooperatives" class="nav-link {{ $active==2?'active':'' }}">
          ...
          <li class="nav-item">
            <a href="/departemental/gics" class="nav-link {{ $active==3?'active':'' }}">
              <i class="nav-icon fas fa-home"></i>
              <p>
                Gics
              </p>
          ...
          <li class="nav-item">
            <a href="/departemental/zones" class="nav-link {{ $active==4?'active':'' }}">
          ...
          <li class="nav-item">
            <a style="font-style:italic" href="/departemental/arrondissements" class="nav-link nav-light">
          ...
          <li class="nav-item">
            <a style="font-style:italic" href="/departemental/users" class="nav-link nav-light">
              <i class="nav-icon fas fa-ellipsis-h"></i>
