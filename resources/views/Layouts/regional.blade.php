 ...
 <!-- <div style="background: linear-gradient(to right, #5bbdd6,#FFFFFF,#5bbdd6);" class="preloader flex-column justify-content-center align-items-center">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link"  href="#"><i class="fas fa-user"></i> {{ $cmpt->name }} / <b class="text-black">{{ $cmpt->region->name }}</b> </a>
      </li>
    ...
    <!-- Brand Logo -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/regional/dashboard" class="nav-link {{ $active==1?'active':'' }}">
          ...
          <li class="nav-item">
            <a href="/regional/producteurs" class="nav-link {{ $active==21?'active':'' }}">
          ...
          <li class="nav-item">
            <a href="/regional/cooperatives" class="nav-link {{ $active==2?'active':'' }}">
          ...
          <li class="nav-item">
            <a href="/regional/gics" class="nav-link {{ $active==3?'active':'' }}">
              <i class="nav-icon fas fa-home"></i>
              <p>
                Gics
              </p>
          ...
          <li class="nav-item">
            <a href="/regional/zones" class="nav-link {{ $active==4?'active':'' }}">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/regional/departements" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Departements</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/regional/arrondissements" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Arrondissements</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a style="font-style:italic" href="/regional/users" class="nav-link nav-light">
              <i class="nav-icon fas fa-ellipsis-h"></i>
